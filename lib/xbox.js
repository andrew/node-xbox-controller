...
XboxController.analyze = function analyze (key, type, axis)
{
	...
	if (type === 'key') {
		...
		for(i=0; i<bufferStore.length; i++) {
			for(n=0; n<bufferStore[i].length; n++) {
				if(bufferStore[i][n] !== original[n] && bufferStore[bufferStore.length-1][n] !== 128 && bufferStore[bufferStore.length-1][n] !==0) {
		...
		for(i=0;i<bufferStore.length;i++){
			for(n=0;n<bufferStore[i].length;n++){
				if(bufferStore[i][n] !== original[n] && axis === 'leftx' && bufferStore[i][n]-original[n]>70) {
				...
				if(bufferStore[i][n] !== original[n] && axis === 'rightx' && bufferStore[i][n]-original[n]>70) {
				...
				if(bufferStore[i][n] !== original[n] && axis === 'lefty' && original[n]-bufferStore[i][n]>70) {
				...
				if(bufferStore[i][n] !== original[n] && axis === 'righty' && original[n]-bufferStore[i][n]>70) {
