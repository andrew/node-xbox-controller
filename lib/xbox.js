...
//Rumble isn't fully working - you made need to enable rumble from the xbox system first!'
XboxController.prototype.setRumble = function() {
  this.sendCommand([0x00, 0x04, 0x00, 0xff ], 'Xbox controller wont set rumble');
};

XboxController.prototype.rumble = function(left, right) {
  left = left || 0xff;
  right = right || 0xff;
  this.sendCommand([0x00, 0x08, 0x00, left, right, 0x00, 0x00, 0x00 ], 'Xbox controller wont rumble');
};
